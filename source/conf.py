# -*- coding: utf-8 -*-
#
# Celadon project documentation build configuration file.
#
...
project = u'Intel® Trust Domain Extension'
...
html_title = "Intel® Trust Domain Extension"
...
latex_documents = [
  (master_doc, 'Intel® TDX', u'Intel® Trust Domain Extension',
   u'many', 'manual'),
]
...
texinfo_documents = [
  (master_doc, 'Intel® TDX', u'Intel® Trust Domain Extension',
   author, 'Intel® TDX', 'One line description of project.',
   'Miscellaneous'),
]
